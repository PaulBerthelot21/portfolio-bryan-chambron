...
// Icônes personnalisées pour les réseaux sociaux
const TwitchIcon = () => (
                    ...
                    <Card
                      className={`h-full transition-colors ${
                        mode === "radio"
                          ...
                          : "bg-slate-800/50 hover:bg-purple-900/30 border-purple-800/50"
                      }`}
                    >
                      <CardHeader className="flex flex-row items-center gap-4">
                        <div
                          className={`p-3 rounded-xl text-white ${social.color}`}
                        >
                          <IconComponent />
                        </div>
                        <div>
